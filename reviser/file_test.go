...
func TestSourceFile_Fix(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				projectName: "github.com/odenio/goimports-reviser",
...
import (
	"github.com/odenio/goimports-reviser/testdata/innderpkg" // test1
...
import (
	...
	"github.com/odenio/goimports-reviser/pkg/somepkg"
)
`,
			},
			want: `package testdata
...
`,
		...
		},
		{
			...
			args: args{
				...
				localPkgPrefixes: "github.com/odenio/goimports-reviser",
				filePath:         "./testdata/example.go",
				fileContent: `package testdata
...
`,
		...
		},
		{
			...
			args: args{
				projectName:      "github.com/odenio/goimports-reviser/code/thispkg",
				localPkgPrefixes: "github.com/odenio/goimports-reviser/code",
				filePath:         "./testdata/example.go",
				fileContent: `package testdata
...
import (
	...
	"github.com/odenio/goimports-reviser/code/foopkg"
	"github.com/odenio/goimports-reviser/code/otherpkg"
	"github.com/odenio/goimports-reviser/code/thispkg/stuff"
	"github.com/odenio/goimports-reviser/code/thispkg/morestuff"
)
...
import (
	"fmt"
	second "github.com/odenio/goimports-reviser/testdata/secondpkg"
	by "bytes"
	js "encoding/json"
	"golang.org/x/exp/slices"
...
import (
	"fmt" //fmt package
	second "github.com/odenio/goimports-reviser/testdata/secondpkg" //secondpkg package
	by "bytes"
	js "encoding/json"
